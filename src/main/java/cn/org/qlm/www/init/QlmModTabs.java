...
public class QlmModTabs {
	...
	public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
		if (tabData.getTabKey() == CreativeModeTabs.COMBAT) {
			...
			tabData.accept(QlmModItems.EMERALDARMOR_HELMET.get());
			tabData.accept(QlmModItems.EMERALDARMOR_CHESTPLATE.get());
			tabData.accept(QlmModItems.EMERALDARMOR_LEGGINGS.get());
			tabData.accept(QlmModItems.EMERALDARMOR_BOOTS.get());
			tabData.accept(QlmModItems.EMERALDSWORD.get());
			...
			tabData.accept(QlmModItems.EMERALDAXE.get());
			tabData.accept(QlmModItems.EMERALDPICKAXE.get());
			tabData.accept(QlmModItems.EMERALDSHOVEL.get());
