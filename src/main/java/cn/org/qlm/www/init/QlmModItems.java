...
import cn.org.qlm.www.item.EmeraldarmorItem;
...
public class QlmModItems {
	...
	public static final RegistryObject<Item> EMERALDARMOR_CHESTPLATE = REGISTRY.register("emeraldarmor_chestplate", () -> new EmeraldarmorItem.Chestplate());
	...
	public static final RegistryObject<Item> EMERALDPICKAXE = REGISTRY.register("emeraldpickaxe", () -> new EmeraldpickaxeItem());
